...
[_QWERTY] = LAYOUT_all(
    ...
    _______,   KC_PDOT, _______,   KC_P0,  KC_LCTL, MO(_FN),                     KC_LALT,  KC_SPC, KC_LGUI,             _______,  KC_SPC, KC_RALT,      KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_ALT] = LAYOUT_all(
    ...
    KC_PENT,     KC_P1,   KC_P2,   KC_P3,   KC_LSFT, _______,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_B,    KC_N,    KC_M, KC_COMM, KC_DOT,     KC_SLSH,          KC_RSFT,      KC_UP,           \
    _______,   KC_PDOT, _______,   KC_P0,  KC_LCTL, KC_LGUI,                     KC_LALT,  KC_SPC, KC_LGUI,             _______,  KC_SPC, KC_RALT,      MO(_FN),     KC_LEFT, KC_DOWN, KC_RGHT
),


[_FN] = LAYOUT_all(
    _______,  _______,  _______, _______,    _______, Song1,   Song2,   Song3,   Song4,   Song5,   Song6,   Song7,   Song8,   Song9,  Song10, Song11, Song12, Song16, _______,  \
